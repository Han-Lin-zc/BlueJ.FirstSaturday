...
public class WriteLoops {
    ...
    public void simpleLoops() {
        ...
        // do while loop will execute once then the condition is checked.
    }
    ...
    public boolean checkGameScoreDoWhile() {
        ...
        // do your while loop here
        do {
          System.out.println(gameNextScore());
          w++;
        } while (runningScore < highestScore);
            // calling
            w = w + 1;
    ...
    public int checkServerStatus() {
        ...
        tryServerRestart("Lets wait", adminPhoneNumber);
        // calling
    ...
    public int tallyVote1() {
        ...
        for (int i = 0; i<voteTallies.length; i++) {
          System.out.println(voteTallies.length);
        }
